> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [blog.codinglabs.org](http://blog.codinglabs.org/articles/theory-of-mysql-index.html)
...
关于 B-Tree 有一系列有趣的性质，例如一个度为 d 的 B-Tree，设其索引 N 个 key，则其树高 h 的上限为

$logd((N+1)/2)$

，检索一个 key，其查找节点个数的渐进复杂度为
